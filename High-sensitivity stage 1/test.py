...
parser.add_argument("--test_data", type=str, default='/test', help='The set of tests we created')
parser.add_argument("--test_noiseL", type=float, default=25, help='noise level used on test set')
parser.add_argument("--display", type=str, default="False", help='Whether to display an image')
parser.add_argument("--test_path", type=str, default="/mnt/pathto/test", help='The loss function used for training')
...
parser.add_argument("--output_path", type=str, default="/mnt/pathto/result", help='result')
